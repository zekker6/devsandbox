...
func NewServer(cfg *Config) (*Server, error) {
	...
	// Initialize credential injectors
	credInjectors := cfg.CredentialInjectors
	if credInjectors == nil {
		credInjectors = DefaultCredentialInjectors()
	}
	...
	s := &Server{
		...
		askServer:           askServer,
		askQueue:            askQueue,
		credentialInjectors: credInjectors,
	}
